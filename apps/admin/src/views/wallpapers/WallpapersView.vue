<template>
  <div class="page-stack">
    ...
    <el-dialog append-to="#awall-overlays" v-model="reuploadVisible" title="补传原图" width="420px" destroy-on-close>
    ...
    <el-dialog append-to="#awall-overlays" v-model="categoryDialogVisible" title="批量改分类" width="420px" destroy-on-close>
